        ...
        <div className="max-w-4xl mx-auto">
          <Card className="border-none shadow-lg">
            <CardContent className="p-8">
              <div className="text-center mb-8">
                <img
                  src="https://imgur.com/FkWIkio.jpg"
                  alt="강진영 손해사정사/법무실장"
                  className="w-40 h-40 rounded-full mx-auto mb-6 object-cover shadow-lg"
                />
                <h2 className="text-3xl font-bold text-law-navy mb-2">강진영</h2>
                <p className="text-law-gold font-semibold text-xl mb-6">손해사정사/법무실장</p>
                <div className="mt-8 pt-8 border-t border-gray-200 bg-law-light rounded-lg p-6">
                <h3 className="text-lg font-semibold text-law-navy mb-4">강진영 손해사정사의 말</h3>
                <blockquote className="text-gray-700 italic text-center">
                  "손해사정의 핵심은 공정함입니다.
                  모든 사건에서 객관적 근거를 바탕으로, 의뢰인이 정당한 보상을 받을 수 있도록 최선을 다하겠습니다."
                </blockquote>
              </div>
              </div>
